  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-end justify-between">
        <div>
          <h2 className="font-bold text-2xl text-[#0d0f14]">Good morning, Amina ✦</h2>
          <p className="text-sm text-gray-400 mt-1">Here is what is happening with your content today</p>
        </div>
            ...
            <tbody>
              {posts.slice(0, 4).map((p) => (
                <tr key={p.id} className="border-b border-gray-50 last:border-0 hover:bg-gray-50 transition-colors">
                  <td className="px-6 py-3 text-sm font-semibold text-[#0d0f14]">{p.title}</td>
